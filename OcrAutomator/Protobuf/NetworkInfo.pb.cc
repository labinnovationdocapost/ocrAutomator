...
void protobuf_AssignDesc_NetworkInfo_2eproto() {
  ...
  static const int NetworkInfo_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(NetworkInfo, port_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(NetworkInfo, version_),
  };
...
void protobuf_AddDesc_NetworkInfo_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\021NetworkInfo.proto\022\033Docapost.IA.Tessera"
    "ct.Proto\",\n\013NetworkInfo\022\014\n\004port\030\001 \002(\005\022\017\n"
    "\007version\030\002 \002(\t", 94);
...
#ifndef _MSC_VER
const int NetworkInfo::kPortFieldNumber;
const int NetworkInfo::kVersionFieldNumber;
#endif  // !_MSC_VER

NetworkInfo::NetworkInfo()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:Docapost.IA.Tesseract.Proto.NetworkInfo)
}
...
NetworkInfo::NetworkInfo(const NetworkInfo& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:Docapost.IA.Tesseract.Proto.NetworkInfo)
}
...
NetworkInfo::~NetworkInfo() {
  // @@protoc_insertion_point(destructor:Docapost.IA.Tesseract.Proto.NetworkInfo)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:Docapost.IA.Tesseract.Proto.NetworkInfo)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:Docapost.IA.Tesseract.Proto.NetworkInfo)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Docapost.IA.Tesseract.Proto.NetworkInfo)
  return false;
#undef DO_
}
...
void NetworkInfo::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:Docapost.IA.Tesseract.Proto.NetworkInfo)
  // required int32 port = 1;
  if (has_port()) {
  ...
  // @@protoc_insertion_point(serialize_end:Docapost.IA.Tesseract.Proto.NetworkInfo)
}

::google::protobuf::uint8* NetworkInfo::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:Docapost.IA.Tesseract.Proto.NetworkInfo)
  // required int32 port = 1;
  if (has_port()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Docapost.IA.Tesseract.Proto.NetworkInfo)
  return target;
}
