...
class NetworkInfo : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:Docapost.IA.Tesseract.Proto.NetworkInfo)
 private:
...
// required int32 port = 1;
inline bool NetworkInfo::has_port() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void NetworkInfo::set_has_port() {
  _has_bits_[0] |= 0x00000001u;
}
inline void NetworkInfo::clear_has_port() {
  _has_bits_[0] &= ~0x00000001u;
}
...
inline ::google::protobuf::int32 NetworkInfo::port() const {
  // @@protoc_insertion_point(field_get:Docapost.IA.Tesseract.Proto.NetworkInfo.port)
  return port_;
}
inline void NetworkInfo::set_port(::google::protobuf::int32 value) {
  set_has_port();
  port_ = value;
  // @@protoc_insertion_point(field_set:Docapost.IA.Tesseract.Proto.NetworkInfo.port)
}

// required string version = 2;
inline bool NetworkInfo::has_version() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void NetworkInfo::set_has_version() {
  _has_bits_[0] |= 0x00000002u;
}
inline void NetworkInfo::clear_has_version() {
  _has_bits_[0] &= ~0x00000002u;
}
...
inline const ::std::string& NetworkInfo::version() const {
  // @@protoc_insertion_point(field_get:Docapost.IA.Tesseract.Proto.NetworkInfo.version)
  return *version_;
}
inline void NetworkInfo::set_version(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:Docapost.IA.Tesseract.Proto.NetworkInfo.version)
}
inline void NetworkInfo::set_version(const char* value) {
  ...
  version_->assign(value);
  // @@protoc_insertion_point(field_set_char:Docapost.IA.Tesseract.Proto.NetworkInfo.version)
}
inline void NetworkInfo::set_version(const char* value, size_t size) {
  set_has_version();
  if (version_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    version_ = new ::std::string;
  }
  version_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:Docapost.IA.Tesseract.Proto.NetworkInfo.version)
}
inline ::std::string* NetworkInfo::mutable_version() {
  ...
  // @@protoc_insertion_point(field_mutable:Docapost.IA.Tesseract.Proto.NetworkInfo.version)
  return version_;
}
...
inline void NetworkInfo::set_allocated_version(::std::string* version) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Docapost.IA.Tesseract.Proto.NetworkInfo.version)
}
